...
import { User } from '../src/user/dtos/user-output.dto';
...
export const seedAdminUser = async (
...
): Promise<{ adminUser: User; authTokenForAdmin: AuthTokenOutput }> => {
    ...
    const adminUser: User = JSON.parse(JSON.stringify(userOutput));
